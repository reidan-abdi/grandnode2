...
public class OrderStatusServiceTests
{
    ...
    public async Task Insert_InvokeExpectedMethods()
    {
        ...
        _mediatorMock.Verify(c => c.Publish(It.IsAny<EntityInserted<OrderStatus>>(), default), Times.Once);
    }
    ...
    public async Task Update_InvokeExpectedMethods()
    {
        ...
        _cacheMock.Verify(c => c.RemoveByPrefix(It.IsAny<string>(), It.IsAny<bool>()), Times.AtLeast(1));
        _mediatorMock.Verify(c => c.Publish(It.IsAny<EntityUpdated<OrderStatus>>(), default), Times.Once);
    }
    ...
    public async Task Delete_InvokeExpectedMethods()
    {
        ...
        _cacheMock.Verify(c => c.RemoveByPrefix(It.IsAny<string>(), It.IsAny<bool>()), Times.AtLeast(1));
        _mediatorMock.Verify(c => c.Publish(It.IsAny<EntityDeleted<OrderStatus>>(), default), Times.Once);
    }
