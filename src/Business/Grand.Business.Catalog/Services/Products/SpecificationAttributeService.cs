...
public class SpecificationAttributeService : ISpecificationAttributeService
{
    ...
    public virtual async Task<SpecificationAttribute> GetSpecificationAttributeByOptionId(
    ...
    public virtual async Task DeleteSpecificationAttributeOption(
        SpecificationAttributeOption specificationAttributeOption)
    {
        ...
        var sao = specificationAttribute.SpecificationAttributeOptions.FirstOrDefault(x =>
            x.Id == specificationAttributeOption.Id);
        if (sao == null)
    ...
    public virtual async Task InsertProductSpecificationAttribute(
        ProductSpecificationAttribute productSpecificationAttribute, string productId)
    {
    ...
    /// <param name="productSpecificationAttribute">Product specification attribute mapping</param>
    /// <param name="productId">Product ident</param>
    public virtual async Task UpdateProductSpecificationAttribute(
        ProductSpecificationAttribute productSpecificationAttribute, string productId)
    {
        ArgumentNullException.ThrowIfNull(productSpecificationAttribute);
    ...
    /// <param name="productId">Product ident</param>
    public virtual async Task DeleteProductSpecificationAttribute(
        ProductSpecificationAttribute productSpecificationAttribute, string productId)
    {
        ArgumentNullException.ThrowIfNull(productSpecificationAttribute);
    ...
    public virtual int GetProductSpecificationAttributeCount(string productId = "",
        string specificationAttributeOptionId = "")
    {
        ...
        if (!string.IsNullOrEmpty(specificationAttributeOptionId))
            query = query.Where(psa =>
                psa.ProductSpecificationAttributes.Any(x =>
